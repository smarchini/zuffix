...
benchmark() {
    ...
    "$SCRIPTPATH"/bin/benchmark/findrandom/nothing-zuffix-wyhash         "$1" --benchmark_format=csv > "$DESTPATH/findrandom.$NAME.nothing-zuffix-wyhash.20230317.csv"
    "$SCRIPTPATH"/bin/benchmark/findrandom/nothing-zuffix-xxh3           "$1" --benchmark_format=csv > "$DESTPATH/findrandom.$NAME.nothing-zuffix-xxh3.20230317.csv"
