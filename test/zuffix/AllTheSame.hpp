...
TEST(AllTheSame, sigma2) {
  battery("ab");
}

TEST(AllTheSame, sigma4) {
  battery("ACGT");
}

TEST(AllTheSame, sigma26) {
  battery("abcdefghijklmnopqrstuvwxyz");
}

TEST(AllTheSame, sigma72) {
  battery("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789");
}
