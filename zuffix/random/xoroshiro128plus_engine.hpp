...
public:
  ...
  static constexpr result_type default_seed[] = {0x333e2c3815b27604,
                                                 0x47ed6e7691d8f09f}; // TODO: are these okay?
...
private:
  ...
  bool operator==(const xoroshiro128plus_engine &oth) const {
    return s[0] == oth.s[0] && s[1] == oth.s[1];
  }
  ...
  friend std::basic_ostream<charT, traits> &operator<<(std::basic_ostream<charT, traits> &os,
                                                       const xoroshiro128plus_engine &x) {
