...
template <typename T, AllocType AT = sux::util::MALLOC, size_t C = 1 << 10> class CRC32ZlibHash {
  public:
  ...
  public:
	CRC32ZlibHash() : string(nullptr), statetable(1) { statetable[0] = 0; }

	CRC32ZlibHash(const T *string, size_t size) : string(string) {
