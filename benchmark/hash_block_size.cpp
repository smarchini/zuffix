...
BM_SIMULATION(CRC32_64B, CRC32ZlibHash<uint8_t COMMA 1 << 6>) 
...
BM_SIMULATION(CRC32_2kB, CRC32ZlibHash<uint8_t COMMA 1 << 11>)
BM_SIMULATION(CRC32_4kB, CRC32ZlibHash<uint8_t COMMA 1 << 12>) // default
BM_SIMULATION(CRC32_8kB, CRC32ZlibHash<uint8_t COMMA 1 << 13>)
BM_SIMULATION(CRC32_16kB, CRC32ZlibHash<uint8_t COMMA 1 << 14>)
BM_SIMULATION(CRC32_32kB, CRC32ZlibHash<uint8_t COMMA 1 << 15>)
BM_SIMULATION(CRC32_64kB, CRC32ZlibHash<uint8_t COMMA 1 << 16>)
BM_SIMULATION(CRC32_128KB, CRC32ZlibHash<uint8_t COMMA 1 << 17>)
BM_SIMULATION(CRC32_256KB, CRC32ZlibHash<uint8_t COMMA 1 << 18>)
BM_SIMULATION(CRC32_512KB, CRC32ZlibHash<uint8_t COMMA 1 << 19>)
BM_SIMULATION(CRC32_1MB, CRC32ZlibHash<uint8_t COMMA 1 << 20>)
