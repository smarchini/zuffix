...
BM_SIMULATION(CRC32CFolly_2kB,  CRC32CFollyHash<uint8_t COMMA 1 << 11>)
BM_SIMULATION(CRC32CFolly_4kB,  CRC32CFollyHash<uint8_t COMMA 1 << 12>)
BM_SIMULATION(CRC32CFolly_8kB,  CRC32CFollyHash<uint8_t COMMA 1 << 13>)
BM_SIMULATION(CRC32CFolly_16kB,  CRC32CFollyHash<uint8_t COMMA 1 << 14>)
BM_SIMULATION(CRC32CFolly_32kB,  CRC32CFollyHash<uint8_t COMMA 1 << 15>)
BM_SIMULATION(CRC32CFolly_64kB,  CRC32CFollyHash<uint8_t COMMA 1 << 16>)
BM_SIMULATION(CRC32CFolly_128kB,  CRC32CFollyHash<uint8_t COMMA 1 << 17>)
...
BM_SIMULATION(CRC32Zlib_2MB, CRC32ZlibHash<uint8_t COMMA 1 << 21>)
BM_SIMULATION(CRC32Zlib_4MB, CRC32ZlibHash<uint8_t COMMA 1 << 22>)
BM_SIMULATION(CRC32Zlib_8MB, CRC32ZlibHash<uint8_t COMMA 1 << 23>)
BM_SIMULATION(CRC32Zlib_16MB, CRC32ZlibHash<uint8_t COMMA 1 << 24>)
BM_SIMULATION(CRC32Zlib_32MB, CRC32ZlibHash<uint8_t COMMA 1 << 25>)
BM_SIMULATION(CRC32Zlib_64MB, CRC32ZlibHash<uint8_t COMMA 1 << 26>)
BM_SIMULATION(CRC32Zlib_128MB, CRC32ZlibHash<uint8_t COMMA 1 << 27>)
...
BM_SIMULATION(CRC32CRC32C_16kB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 14>)
BM_SIMULATION(CRC32CRC32C_32kB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 15>)
BM_SIMULATION(CRC32CRC32C_64kB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 16>)
BM_SIMULATION(CRC32CRC32C_128kB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 17>)
BM_SIMULATION(CRC32CRC32C_256kB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 18>)
BM_SIMULATION(CRC32CRC32C_512kB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 19>)
BM_SIMULATION(CRC32CRC32C_1MB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 20>)
BM_SIMULATION(CRC32CRC32C_2MB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 21>)
BM_SIMULATION(CRC32CRC32C_4MB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 22>)
BM_SIMULATION(CRC32CRC32C_8MB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 23>)
BM_SIMULATION(CRC32CRC32C_16MB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 24>)
BM_SIMULATION(CRC32CRC32C_32MB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 25>)
BM_SIMULATION(CRC32CRC32C_64MB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 26>)
BM_SIMULATION(CRC32CRC32C_128MB,   CRC32Plus32CFollyHash<uint8_t COMMA 1 << 27>)
...
BM_SIMULATION(XXH3_2MB, XXH3Hash<uint8_t COMMA 1 << 21>)
BM_SIMULATION(XXH3_4MB, XXH3Hash<uint8_t COMMA 1 << 22>)
BM_SIMULATION(XXH3_8MB, XXH3Hash<uint8_t COMMA 1 << 23>)
BM_SIMULATION(XXH3_16MB, XXH3Hash<uint8_t COMMA 1 << 24>)
